...
class CEditText  : AppCompatEditText {
    ...
    private fun selectTypeface(context: Context, textStyle: Int): Typeface {
        return return when (textStyle) {
            ...
            Typeface.NORMAL -> Typeface.createFromAsset(context.assets, "Poppins-Medium.ttf")// regular
            else -> Typeface.createFromAsset(context.assets, "Poppins-Medium.ttf")// regular
        }
    }
