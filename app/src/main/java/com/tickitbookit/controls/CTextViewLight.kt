...
class CTextViewLight  : AppCompatTextView {
    ...
    private fun selectTypeface(context: Context, textStyle: Int): Typeface {
        return return when (textStyle) {
            ...
            Typeface.NORMAL -> Typeface.createFromAsset(context.assets, "Poppins-Light.ttf")// regular
            else -> Typeface.createFromAsset(context.assets, "Poppins-Light.ttf")// regular
        }
    }
